						...
						<div class="portlet-body">
							...
							<?php
								if(isset($_POST['submit'])) {
									...
									$sql = "UPDATE news SET title_bg='".$title_bg."', body_bg='".$body_bg."', title_en='".$title_en."', body_en='".$body_en."', title_de='".$title_de."', body_de='".$body_de."' WHERE id='".$_GET['id']."'";

									if ($conn->query($sql) === TRUE) {
										echo "<div class=\"note note-success\">
                                                    <p>Статията е обновена успешно. <a href=\"./news.php\">Към списъка със статии</a></p>
                                                 </div>";
									} else {
							...
							<div class="tabbable-custom ">
								<form action="" method="post">
									...
									?>
									<br />
									<button type="submit" name="submit" class="btn blue">Запази статията</button>
								</form>
								<script>
