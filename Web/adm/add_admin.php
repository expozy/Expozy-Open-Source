					...
					<div class="portlet light">
						...
						<div class="portlet-body">
								...
								if(isset($_POST['mail'])) {
									if(empty($_POST['mail']) || empty($_POST['pass'])) {
										echo '<div class="note note-danger">
                                                    <p> Грешка: Моля, попълнете всички полета!</p>
                                                 </div>';
									} else {
										$mail = $_POST['mail'];
										$pass = md5(md5($_POST['pass']));
										$sql = "INSERT INTO admins (mail, password)
										VALUES ('$mail', '$pass')";

										if ($conn->query($sql) === TRUE) {
											echo "<div class=\"note note-success\">
                                                    <p>Администраторът е добавен успешно. <a href=\"./admins.php\">Към списъка с администратори</a></p>
                                                 </div>";
										} else {
							...
							<div class="form-group">
								...
								<input type="text" name="mail" class="form-control input-medium" placeholder="example@domain.com">
								<div class="input-icon right input-medium margin-top-10">
									<label>Парола</label>
									<input type="password" name="pass" class="form-control" placeholder="Парола"> </div>
