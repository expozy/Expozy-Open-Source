						...
						<div class="portlet-body">
							...
							<?php
								if(isset($_POST['submit'])) {
									...
									$sql = "INSERT INTO pages (title_bg, body_bg, title_en, body_en, title_de, body_de, slug)
									VALUES ('".$title_bg."', '".$body_bg."', '".$title_en."', '".$body_en."', '".$title_de."', '".$body_de."', '".$slug."')";

									if ($conn->query($sql) === TRUE) {
										echo "<div class=\"note note-success\">
                                                    <p>Страницата е добавена успешно. <a href=\"./pages.php\">Към списъка със страници</a></p>
                                                 </div>";
									} else {
